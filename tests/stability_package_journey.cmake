...
if(DEFINED PACKAGE_VERSION AND NOT "${PACKAGE_VERSION}" STREQUAL "")
    file(GLOB _packages "${BUILD_DIR}/subcli-${PACKAGE_VERSION}-*.zip" "${BUILD_DIR}/subcli-${PACKAGE_VERSION}-*.tar.gz")
else()
    file(GLOB _packages "${BUILD_DIR}/subcli-*.zip" "${BUILD_DIR}/subcli-*.tar.gz")
endif()
list(SORT _packages)
if(NOT _packages)
    message(FATAL_ERROR "No matching CPack package found in ${BUILD_DIR}. Build the package target before running this test.")
endif()
