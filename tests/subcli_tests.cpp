...
int main() {
    ...
    runTest("testLoadProfileAcceptsRuleWithoutValueOrLists", testLoadProfileAcceptsRuleWithoutValueOrLists);
    runTest("testLoadProfileAcceptsFinalRuleWithoutOutbound", testLoadProfileAcceptsFinalRuleWithoutOutbound);
    runTest("testLoadProfileReadsTemplatePolicy", testLoadProfileReadsTemplatePolicy);
    runTest("testLoadProfileRejectsUnknownTemplatePolicyTarget", testLoadProfileRejectsUnknownTemplatePolicyTarget);
    runTest("testLoadProfileRejectsUnknownTemplatePolicyPath", testLoadProfileRejectsUnknownTemplatePolicyPath);
    runTest("testLoadProfileRejectsUnknownTemplatePolicyAction", testLoadProfileRejectsUnknownTemplatePolicyAction);
    runTest("testLoadProfileRejectsMergeOnSingBoxRouteRules", testLoadProfileRejectsMergeOnSingBoxRouteRules);
    runTest("testLoadProfileAcceptsAppendOnSingBoxRouteRules", testLoadProfileAcceptsAppendOnSingBoxRouteRules);
    runTest("testLoadProfileRejectsMergeOnXrayDnsServers", testLoadProfileRejectsMergeOnXrayDnsServers);
    runTest("testLoadProfileAcceptsReplaceOnXrayDnsServers", testLoadProfileAcceptsReplaceOnXrayDnsServers);
    runTest("testLoadProfileRejectsAppendOnMihomoDns", testLoadProfileRejectsAppendOnMihomoDns);
    runTest("testLoadProfileAcceptsMergeOnMihomoDns", testLoadProfileAcceptsMergeOnMihomoDns);
    runTest("testLoadProfileRejectsTemplatePolicyParentChildConflict", testLoadProfileRejectsTemplatePolicyParentChildConflict);
    runTest("testLoadProfileWithBuiltInExtendsMergesOverrides", testLoadProfileWithBuiltInExtendsMergesOverrides);
    runTest("testLoadProfileRejectsUnknownExtendsBase", testLoadProfileRejectsUnknownExtendsBase);
    runTest("testBuiltInProfilesExistAndLoad", testBuiltInProfilesExistAndLoad);
    runTest("testExportProfileResolverLoadsBuiltInProfile", testExportProfileResolverLoadsBuiltInProfile);
    runTest("testExportProfileResolverOverrideLoadsBuiltInProfile", testExportProfileResolverOverrideLoadsBuiltInProfile);
    runTest("testExportProfileResolverOverrideLoadsPath", testExportProfileResolverOverrideLoadsPath);
    runTest("testExportProfileResolverFailsForMissingProfilePath", testExportProfileResolverFailsForMissingProfilePath);
    runTest("testExportProfileResolverFailsForInvalidProfileJson", testExportProfileResolverFailsForInvalidProfileJson);
    runTest("testSingBoxTemplatePolicyRejectRouteRulesPreservesTemplateWithWarning", testSingBoxTemplatePolicyRejectRouteRulesPreservesTemplateWithWarning);
    runTest("testSingBoxTemplatePolicyMergeOutbounds", testSingBoxTemplatePolicyMergeOutbounds);
    runTest("testSingBoxTemplatePolicyAppendDnsRules", testSingBoxTemplatePolicyAppendDnsRules);
    runTest("testSingBoxTemplatePolicyMergeRuleSetByTag", testSingBoxTemplatePolicyMergeRuleSetByTag);
    runTest("testSingBoxTemplatePolicyMergeDnsServersKeepsUntaggedTemplateEntries", testSingBoxTemplatePolicyMergeDnsServersKeepsUntaggedTemplateEntries);
    runTest("testXrayTemplatePolicyRejectRoutingRulesPreservesTemplateWithWarning", testXrayTemplatePolicyRejectRoutingRulesPreservesTemplateWithWarning);
    runTest("testXrayTemplatePolicyMergeBalancersByTagKeepsTemplateBalancer", testXrayTemplatePolicyMergeBalancersByTagKeepsTemplateBalancer);
    runTest("testMihomoTemplatePolicyRejectRulesPreservesTemplateWithWarning", testMihomoTemplatePolicyRejectRulesPreservesTemplateWithWarning);
    runTest("testMihomoTemplatePolicyMergeProxiesByNameKeepsTemplateProxy", testMihomoTemplatePolicyMergeProxiesByNameKeepsTemplateProxy);
    runTest("testMihomoTemplatePolicyRejectDnsPreservesTemplateWithWarning", testMihomoTemplatePolicyRejectDnsPreservesTemplateWithWarning);
    runTest("testTemplatePolicyExportsRemainParseableForAllTargets", testTemplatePolicyExportsRemainParseableForAllTargets);
    runTest("testProfileExplainTextShowsDnsGroupsRulesAndPolicy", testProfileExplainTextShowsDnsGroupsRulesAndPolicy);
    runTest("testProfileExplainTargetShowsSingBoxRequiredAssets", testProfileExplainTargetShowsSingBoxRequiredAssets);
    runTest("testProfileExplainJsonIncludesProfileDnsGroupsRules", testProfileExplainJsonIncludesProfileDnsGroupsRules);
    runTest("testProfileExplainAllTargetsIncludesCapabilitySections", testProfileExplainAllTargetsIncludesCapabilitySections);
    runTest("testProfileExplainFallbackWhenConfigLoadFails", testProfileExplainFallbackWhenConfigLoadFails);
    runTest("testBuiltInAutoGroupsDoNotReferenceProxy", testBuiltInAutoGroupsDoNotReferenceProxy);
    runTest("testProtocolRegistryCoversOfficialTargets", testProtocolRegistryCoversOfficialTargets);
    runTest("testDiagnosticServiceReportsConfigAndTargets", testDiagnosticServiceReportsConfigAndTargets);
    runTest("testCliOutputStatusJson", testCliOutputStatusJson);
    runTest("testCliOutputDiagnosticsJson", testCliOutputDiagnosticsJson);
    runTest("testBashCompletionContainsCommands", testBashCompletionContainsCommands);
    runTest("testCompletionScriptContainsRegistryKeysAndTargets", testCompletionScriptContainsRegistryKeysAndTargets);
    runTest("testCompletionSubcommandListIncludesLifecycleVerbs", testCompletionSubcommandListIncludesLifecycleVerbs);
    runTest("testCMakeVersionIs027", testCMakeVersionIs027);
    runTest("testPlatformExecutableCheckRecognizesCurrentTestBinary", testPlatformExecutableCheckRecognizesCurrentTestBinary);
    runTest("testPlatformRunProcessCaptureSuccessAndFailure", testPlatformRunProcessCaptureSuccessAndFailure);
    runTest("testPlatformRunProcessCaptureTimeout", testPlatformRunProcessCaptureTimeout);
    runTest("testCoreCheckPreservesCapturedOutputForFailedChecks", testCoreCheckPreservesCapturedOutputForFailedChecks);
    runTest("testDaemonBuildsExpectedArgs", testDaemonBuildsExpectedArgs);
    runTest("testDaemonProcessLifecycle", testDaemonProcessLifecycle);
    runTest("testDaemonProcessLifecycleWithCustomFiles", testDaemonProcessLifecycleWithCustomFiles);
    runTest("testStartDaemonProcessFailsWhenLogFileCannotOpen", testStartDaemonProcessFailsWhenLogFileCannotOpen);
    runTest("testStartDaemonProcessFailsWhenExecCannotStart", testStartDaemonProcessFailsWhenExecCannotStart);
    runTest("testRunDaemonCycleWithStateUpdatesSuccessSummary", testRunDaemonCycleWithStateUpdatesSuccessSummary);
    runTest("testInspectDaemonProcessExposesLastCycleFailure", testInspectDaemonProcessExposesLastCycleFailure);
    runTest("testInspectDaemonProcessClassifiesStaleStatus", testInspectDaemonProcessClassifiesStaleStatus);
    runTest("testRunDaemonCycleWithStatePersistsFailureSummaryWithoutState", testRunDaemonCycleWithStatePersistsFailureSummaryWithoutState);
    runTest("testDaemonCycleRestartsOnlyRunningCores", testDaemonCycleRestartsOnlyRunningCores);
    runTest("testDaemonCycleStopsOnUpdateFailure", testDaemonCycleStopsOnUpdateFailure);
    runTest("testCapabilityWarningsAreSpecific", testCapabilityWarningsAreSpecific);
    runTest("testLegacyBridgeBuildsStructuredCoreOptions", testLegacyBridgeBuildsStructuredCoreOptions);
    runTest("testStructuredWritersPreserveVlessEncryption", testStructuredWritersPreserveVlessEncryption);
    runTest("testStructuredWritersNormalizeShadowsocksNames", testStructuredWritersNormalizeShadowsocksNames);
    runTest("testWireGuardWritersUseTargetSchemas", testWireGuardWritersUseTargetSchemas);
    runTest("testExportSingBoxWireGuardUsesEndpoint", testExportSingBoxWireGuardUsesEndpoint);
    runTest("testModernUdpWritersUseTargetSchemas", testModernUdpWritersUseTargetSchemas);
    runTest("testSingBoxModernUdpWritersUseStructuredFields", testSingBoxModernUdpWritersUseStructuredFields);
    runTest("testModernUdpXraySkipsUnsupportedProtocols", testModernUdpXraySkipsUnsupportedProtocols);
    runTest("testXrayBuiltInOutboundsParseAndExport", testXrayBuiltInOutboundsParseAndExport);
    runTest("testNativeLongTailPassthroughWriters", testNativeLongTailPassthroughWriters);
    runTest("testParseXrayJson", testParseXrayJson);
    runTest("testParseUriIgnoresInvalidVmessPort", testParseUriIgnoresInvalidVmessPort);
    runTest("testParseModernUdpUriLinks", testParseModernUdpUriLinks);
    runTest("testUriClientFingerprintPreservedForTlsNodes", testUriClientFingerprintPreservedForTlsNodes);
    runTest("testUriClientFingerprintAliasMappingAndPrecedence", testUriClientFingerprintAliasMappingAndPrecedence);
    runTest("testUriClientFingerprintTrojanAndNonTlsGate", testUriClientFingerprintTrojanAndNonTlsGate);
    runTest("testExporterFingerprintPropagationAcrossTargets", testExporterFingerprintPropagationAcrossTargets);
    runTest("testFingerprintPromotionPrecedenceKeepsStructuredValue", testFingerprintPromotionPrecedenceKeepsStructuredValue);
    runTest("testUnknownFormatHintFallsBackToAuto", testUnknownFormatHintFallsBackToAuto);
    runTest("testHintParseFailedFallsBackToAuto", testHintParseFailedFallsBackToAuto);
    runTest("testParseMihomoHttpOpts", testParseMihomoHttpOpts);
    runTest("testParseMihomoH2Opts", testParseMihomoH2Opts);
    runTest("testParseMihomoLocalProxyProvider", testParseMihomoLocalProxyProvider);
    runTest("testParseMihomoRemoteProxyProvider", testParseMihomoRemoteProxyProvider);
    runTest("testParseMihomoRemoteProxyProviderWithHttpFields", testParseMihomoRemoteProxyProviderWithHttpFields);
    runTest("testParseMihomoHighFrequencyOptionalFields", testParseMihomoHighFrequencyOptionalFields);
    runTest("testParseSingBoxTlsDisabledObject", testParseSingBoxTlsDisabledObject);
    runTest("testParseSingBoxHighFrequencyOptionalFields", testParseSingBoxHighFrequencyOptionalFields);
    runTest("testParseXrayHighFrequencyOptionalFields", testParseXrayHighFrequencyOptionalFields);
    runTest("testParseWireGuardNativeShapes", testParseWireGuardNativeShapes);
    runTest("testParseModernUdpNativeShapes", testParseModernUdpNativeShapes);
    runTest("testExportSingBox", testExportSingBox);
    runTest("testParseSingBoxExtendedProtocols", testParseSingBoxExtendedProtocols);
    runTest("testExportFilteringByTarget", testExportFilteringByTarget);
    runTest("testExportXrayUsesStableRandomBalancer", testExportXrayUsesStableRandomBalancer);
    runTest("testExportXraySupportsLeastLoadStrategyFromTemplate", testExportXraySupportsLeastLoadStrategyFromTemplate);
    runTest("testExportSingBoxDnsRuleUsesRouteActionWithPort53", testExportSingBoxDnsRuleUsesRouteActionWithPort53);
    runTest("testMihomoExportIncludesBypassCnProfileRules", testMihomoExportIncludesBypassCnProfileRules);
    runTest("testMihomoExportSupportsGlobalAndDirectProfiles", testMihomoExportSupportsGlobalAndDirectProfiles);
    runTest("testSingBoxExportIncludesBypassCnProfileRules", testSingBoxExportIncludesBypassCnProfileRules);
    runTest("testSingBoxAndXrayExportSupportDirectProfile", testSingBoxAndXrayExportSupportDirectProfile);
    runTest("testXrayExportIncludesBypassCnProfileRules", testXrayExportIncludesBypassCnProfileRules);
    runTest("testXrayProfileDnsAndRulesRenderFromProfile", testXrayProfileDnsAndRulesRenderFromProfile);
    runTest("testXrayProfileGroupsRenderBalancersWithManagedTags", testXrayProfileGroupsRenderBalancersWithManagedTags);
    runTest("testXrayProfileGroupsExpandTagSelectorToManagedTags", testXrayProfileGroupsExpandTagSelectorToManagedTags);
    runTest("testXrayProfileFallbackWarnsWhenLossy", testXrayProfileFallbackWarnsWhenLossy);
    runTest("testXrayProfileGroupsSynthesizeMissingProxyAndAuto", testXrayProfileGroupsSynthesizeMissingProxyAndAuto);
    runTest("testXrayProfileBalancerReferencesAreResolvedAndWarnWhenLossy", testXrayProfileBalancerReferencesAreResolvedAndWarnWhenLossy);
    runTest("testXrayProfileInvalidFallbackDefaultIsOmittedWithWarning", testXrayProfileInvalidFallbackDefaultIsOmittedWithWarning);
    runTest("testXrayProfileDefaultAutoSynthesizesAutoWhenProxyDoesNotReferenceIt", testXrayProfileDefaultAutoSynthesizesAutoWhenProxyDoesNotReferenceIt);
    runTest("testXrayProfileCyclicGroupsDoNotEmitRecursiveSelectors", testXrayProfileCyclicGroupsDoNotEmitRecursiveSelectors);
    runTest("testStructuredFieldsSurviveExportNormalization", testStructuredFieldsSurviveExportNormalization);
    runTest("testNodeManagementPreprocess", testNodeManagementPreprocess);
    runTest("testExpandProfileMembersExpandsRegionWildcardInOrder", testExpandProfileMembersExpandsRegionWildcardInOrder);
    runTest("testExpandProfileMembersExpandsSingleRegionOnlyWhenPresent", testExpandProfileMembersExpandsSingleRegionOnlyWhenPresent);
    runTest("testExpandProfileMembersExpandsNodeWildcard", testExpandProfileMembersExpandsNodeWildcard);
    runTest("testExpandProfileMembersKeepsLiteralMembersAndDedupes", testExpandProfileMembersKeepsLiteralMembersAndDedupes);
    runTest("testExpandProfileMembersExpandsSourceWildcardAndSpecificSource", testExpandProfileMembersExpandsSourceWildcardAndSpecificSource);
    runTest("testExpandProfileMembersExpandsProtocolSelector", testExpandProfileMembersExpandsProtocolSelector);
    runTest("testExpandProfileMembersExpandsTagSelector", testExpandProfileMembersExpandsTagSelector);
    runTest("testInvalidRegexIsIgnored", testInvalidRegexIsIgnored);
    runTest("testWriteFileCreatesParentDirectories", testWriteFileCreatesParentDirectories);
    runTest("testLoadConfigMalformedYamlThrows", testLoadConfigMalformedYamlThrows);
    runTest("testReadLogTailLines", testReadLogTailLines);
    runTest("testRuntimeStatePersistsLogMetadata", testRuntimeStatePersistsLogMetadata);
    runTest("testRuntimeLogPathNormalizesTarget", testRuntimeLogPathNormalizesTarget);
    runTest("testStartCoreRuntimeWritesConfiguredLog", testStartCoreRuntimeWritesConfiguredLog);
    runTest("testStartCoreRuntimeAcceptsBasenameLogPath", testStartCoreRuntimeAcceptsBasenameLogPath);
    runTest("testStartCoreRuntimeRejectsInvalidLogPath", testStartCoreRuntimeRejectsInvalidLogPath);
    runTest("testCoreRuntimeLifecycle", testCoreRuntimeLifecycle);
    runTest("testStopCoreRuntimeRemovesStaleStateFile", testStopCoreRuntimeRemovesStaleStateFile);
    runTest("testStartCoreRuntimeInvalidBinaryLeavesNoState", testStartCoreRuntimeInvalidBinaryLeavesNoState);
    runTest("testCapabilityMatrixAssessesProfileGroupsAcrossTargets", testCapabilityMatrixAssessesProfileGroupsAcrossTargets);
    runTest("testCapabilityMatrixFlagsMissingSingBoxAssetsWithConfigAwareAssess", testCapabilityMatrixFlagsMissingSingBoxAssetsWithConfigAwareAssess);
    runTest("testCapabilityMatrixAssessesFakeIpDnsModeByTarget", testCapabilityMatrixAssessesFakeIpDnsModeByTarget);
    runTest("testCapabilityMatrixFlagsUnsupportedRouteRuleType", testCapabilityMatrixFlagsUnsupportedRouteRuleType);
    runTest("testCapabilityMatrixFlagsUnsupportedSingBoxGeoRuleValues", testCapabilityMatrixFlagsUnsupportedSingBoxGeoRuleValues);
    ...
    runTest("testSubscriptionServiceImportRejectsMissingNameAndUrl", testSubscriptionServiceImportRejectsMissingNameAndUrl);
    runTest("testSubscriptionServiceMergeUpdatesByIdAndName", testSubscriptionServiceMergeUpdatesByIdAndName);
    runTest("testSubscriptionServiceReplaceModeReturnsOnlyImported", testSubscriptionServiceReplaceModeReturnsOnlyImported);
    runTest("testSubscriptionServiceYamlTypedDecodeErrorDoesNotCrash", testSubscriptionServiceYamlTypedDecodeErrorDoesNotCrash);
    runTest("testSubscriptionServiceUriListIgnoresCommentsAndRejectsInvalidLines", testSubscriptionServiceUriListIgnoresCommentsAndRejectsInvalidLines);
    runTest("testSubscriptionServicePruneDisabledDryRun", testSubscriptionServicePruneDisabledDryRun);
    runTest("testSubscriptionServiceBatchSetGroupByTag", testSubscriptionServiceBatchSetGroupByTag);
    runTest("testSubscriptionServicePruneFailedDays", testSubscriptionServicePruneFailedDays);
    ...
    runTest("testRegistryContainsCurrentExportTargets", testRegistryContainsCurrentExportTargets);
    runTest("testExportTargetRegistryHasTemplateAndCoreKeys", testExportTargetRegistryHasTemplateAndCoreKeys);
    runTest("testExportTargetEnumRegistryConsistency", testExportTargetEnumRegistryConsistency);
    runTest("testExportTargetResolveAndOutputPathUseRegistryMetadata", testExportTargetResolveAndOutputPathUseRegistryMetadata);
    runTest("testExportTargetResolveRejectsUnknownTarget", testExportTargetResolveRejectsUnknownTarget);
    runTest("testRegistryContainsCurrentCommandSurface", testRegistryContainsCurrentCommandSurface);
    runTest("testRegistryFindConfigKeySupportsPrefixDescriptors", testRegistryFindConfigKeySupportsPrefixDescriptors);
    runTest("testRegistryExportDescriptorIncludesExpectedOptions", testRegistryExportDescriptorIncludesExpectedOptions);
    runTest("testRegistrySubDescriptorMentionsDataLifecycleCommands", testRegistrySubDescriptorMentionsDataLifecycleCommands);
    runTest("testConfigServiceSetGetRemoveScalarKeys", testConfigServiceSetGetRemoveScalarKeys);
    runTest("testConfigServiceResolvesTemplateAndAssetPathsRelativeToConfigDir", testConfigServiceResolvesTemplateAndAssetPathsRelativeToConfigDir);
    runTest("testConfigServiceRejectsUnknownAndBadValues", testConfigServiceRejectsUnknownAndBadValues);
    runTest("testCMakeVersionIsV027", testCMakeVersionIsV027);
    runTest("testConfigDocsMentionRegistryKeys", testConfigDocsMentionRegistryKeys);
    runTest("testStorePersistsRoutingRules", testStorePersistsRoutingRules);
    runTest("testStorePersistsStrategyGroups", testStorePersistsStrategyGroups);
    runTest("testCustomRoutingRulesMapToAllTargets", testCustomRoutingRulesMapToAllTargets);
    runTest("testMatchRoutingRuleMapsToAllTargets", testMatchRoutingRuleMapsToAllTargets);
    runTest("testPrivateRoutingRulesMapToAllTargets", testPrivateRoutingRulesMapToAllTargets);
    runTest("testCustomStrategyGroupsRenderForMihomoAndSingBox", testCustomStrategyGroupsRenderForMihomoAndSingBox);
    runTest("testFallbackAndLoadBalanceGroupsRenderForMihomoAndSingBox", testFallbackAndLoadBalanceGroupsRenderForMihomoAndSingBox);
    runTest("testMihomoProfileGroupsRenderAndExpandMembers", testMihomoProfileGroupsRenderAndExpandMembers);
    runTest("testMihomoWithEmptyProfileGroupsKeepsLegacyGroupBehavior", testMihomoWithEmptyProfileGroupsKeepsLegacyGroupBehavior);
    runTest("testMihomoProfileGroupsSynthesizeMissingProxyAndAuto", testMihomoProfileGroupsSynthesizeMissingProxyAndAuto);
    runTest("testSingBoxProfileSelectRendersSelector", testSingBoxProfileSelectRendersSelector);
    runTest("testSingBoxProfileUrlTestRendersUrltest", testSingBoxProfileUrlTestRendersUrltest);
    runTest("testSingBoxProfileFallbackDegradesToUrltestWithWarning", testSingBoxProfileFallbackDegradesToUrltestWithWarning);
    runTest("testSingBoxProfileLoadBalanceDegradesToSelectorWithWarning", testSingBoxProfileLoadBalanceDegradesToSelectorWithWarning);
    runTest("testSingBoxProfileGroupsSynthesizeMissingProxyAndAuto", testSingBoxProfileGroupsSynthesizeMissingProxyAndAuto);
    runTest("testSingBoxWithEmptyProfileGroupsKeepsLegacyGroupBehavior", testSingBoxWithEmptyProfileGroupsKeepsLegacyGroupBehavior);
    runTest("testSingBoxProfileEmptyMembersDefaultToDirect", testSingBoxProfileEmptyMembersDefaultToDirect);
    runTest("testSingBoxProfileGroupAliasSpellings", testSingBoxProfileGroupAliasSpellings);
    runTest("testSingBoxProfileRegionMemberRendersRegionSelector", testSingBoxProfileRegionMemberRendersRegionSelector);
    runTest("testSingBoxProfileRegionWildcardRendersReferencedRegionSelectors", testSingBoxProfileRegionWildcardRendersReferencedRegionSelectors);
    runTest("testSingBoxProfileDnsAndRulesRenderFromProfile", testSingBoxProfileDnsAndRulesRenderFromProfile);
    runTest("testSingBoxProfileEmptyDnsUsesExistingResolverTag", testSingBoxProfileEmptyDnsUsesExistingResolverTag);
    runTest("testMihomoProfileDnsAndRulesRenderFromProfile", testMihomoProfileDnsAndRulesRenderFromProfile);
    runTest("testMihomoProfileEmptyRulesFallbackToDefaultOutbound", testMihomoProfileEmptyRulesFallbackToDefaultOutbound);
    runTest("testMihomoProfileListValuedRulesRenderAllEntries", testMihomoProfileListValuedRulesRenderAllEntries);
    runTest("testAssetRecordsExposeConfiguredFiles", testAssetRecordsExposeConfiguredFiles);
    runTest("testMissingAssetsReturnsOnlyMissingRecords", testMissingAssetsReturnsOnlyMissingRecords);
    runTest("testUpdateAssetPersistsMetadata", testUpdateAssetPersistsMetadata);
